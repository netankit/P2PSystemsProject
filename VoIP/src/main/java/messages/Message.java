...
public interface Message {
	...
	public enum MessageType {
		...
		DHT_MESSAGE, KX_MESSAGE, VOIP_MESSAGE, MSG_DHT_GET, MSG_DHT_PUT, MSG_DHT_TRACE, MSG_KX_TN_READY, MSG_VOIP_CALL_INITIATE, MSG_VOIP_CALL_OK, MSG_VOIP_CALL_BUSY, MSG_VOIP_CALL_WAITING, MSG_VOIP_CALL_INITIATE_OK, MSG_VOIP_CALL_DATA, MSG_VOIP_CALL_CALL_END, MSG_VOIP_HEART_BEAT, MSG_VOIP_HEART_BEAT_REPLY
