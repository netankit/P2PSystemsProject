...
public class AudioRecord extends Thread {
	...
	/**
	 * when an audio block is ready, put it back into this queue.
	 * AudioRecord is the producer, SenderThread is consumer.
	 */
	...
	public AudioRecord(AudioFormat audioFormat,
			BlockingQueue<AudioDataBlock> carrierQueue,
	...
	public void stopRecording()
	{
		...
		try
		{
			...
			block.actualDataBlockSize = -1; // notify the SenderThread that there is no block any more.
