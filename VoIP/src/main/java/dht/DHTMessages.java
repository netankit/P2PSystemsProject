	...
	public ExchangePointInfo CallDHTTrace(String key)
	{
		...
		try
		{
			...
			if(statusMsg ==  Message.MessageType.MSG_DHT_TRACE_REPLY.getValue())
			{
				...
				{
					exchangeInfo.setPeerId(CommonFunctions.ByteArrayToString(hmap.get("peer_id_n3")));
					exchangeInfo.setKxIPv4Address(CommonFunctions.ByteArrayToString(hmap.get("ipv4_address_n3")));
					exchangeInfo.setKxIPv6Address(CommonFunctions.ByteArrayToString(hmap.get("ipv6_address_n3")));
					exchangeInfo.setKxPotNumber(CommonFunctions.ByteArrayToString(hmap.get("kx_port_n3")));
					
				} 
				if (hmap.containsKey("peer_id_n2"))
				{
					exchangeInfo.setPeerId(CommonFunctions.ByteArrayToString(hmap.get("peer_id_n2")));
					exchangeInfo.setKxIPv4Address(CommonFunctions.ByteArrayToString(hmap.get("ipv4_address_n2")));
					exchangeInfo.setKxIPv6Address(CommonFunctions.ByteArrayToString(hmap.get("ipv6_address_n2")));
					exchangeInfo.setKxPotNumber(CommonFunctions.ByteArrayToString(hmap.get("kx_port_n2")));
				}*/
